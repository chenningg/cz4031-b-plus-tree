...
int main()
{
  ...
  std::cout << "Pool size: " << db.getPoolSize() << '\n';
  std::cout << "Block size: " << db.getBlockSize() << '\n';

  Movie test{false, 5.6, 12312, "tt2351125"};
  std::cout << "Size of a record: " << sizeof(test) << '\n';

  std::cout << "Current blocks available: " << db.getAvailable() << '\n';
